...
@synthesize window;
@synthesize userid ,loginname ,recievedata ,groupname ,pdata ,prayer1,comment1;
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {    
	...
	//showProfile *l1 = [[showProfile alloc]init];
	
	
	
		UINavigationController *nv = [[UINavigationController alloc]initWithRootViewController:l1];
